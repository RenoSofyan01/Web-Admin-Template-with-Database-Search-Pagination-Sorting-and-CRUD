...
<?php
    ...
    $query = "SELECT * FROM tb_provinsi WHERE no = '$no';";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="provinsi.php">Provinsi</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="container">
    <form method="POST" action="prosesprovinsi.php" enctype="multipart/form-data">
    ...
    <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            <label for="province" class="col-sm-2 col-form-label">Province</label>
                <div class="col-sm-10">
                    <input type="text" name="province" id="inputprovince" class="form-control" placeholder="Input Province" value="<?php echo $pr;?>">
                </div>
        </div>
    <div class="mb-3 row">
        <label for="start" class="col-sm-2 col-form-label">Start</label>
        <div class="col-sm-10">
            <input type="date" name="start" id="inputstart" class="form-control" placeholder="Input Start" value="<?php echo $st;?>">
        </div>
    </div>
    <div class="mb-3 row">
        <label for="finish" class="col-sm-2 col-form-label">Finish</label>
        <div class="col-sm-10">
            <input type="date" name="finish" id="inputfinish" class="form-control" placeholder="Input Finish" value="<?php echo $fi;?>">
        </div>
    </div>
    <div class="mb-3 row">
        <label for="info" class="col-sm-2 col-form-label">Info</label>
        <div class="col-sm-10">
            <input type="date" name="info" id="inputinfo" class="form-control" placeholder="Input Info" value="<?php echo $in;?>">
        </div>
    </div>
    <div class="mb-3 row mt-4">
        ...
        ?>
        <a href="provinsi.php" class="btn btn-danger" type="button">Cancel</a>
        </div>
    </div>
    </form>
