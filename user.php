...
<div class="container">
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <a href="kelolauser.php" class="btn btn-primary me-md-2 mt-4 md-4" type="button"><i class="fa fa-plus" aria-hidden="true"></i> Add New Data</a>
    </div>
    ...
    <table id="tb" class="table table-success table-striped align-middle table-hover" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="kelolauser.php?ubah=<?php echo $result['no'];?>" class="btn btn-primary me-md-2" type="button">Edit</a>
                            <a href="prosesuser.php?hapus=<?php echo $result['no'];?>" class="btn btn-danger" onClick="return confirm('Are you sure?')" type="button">Delete</a>
                        </div>
                    </td>
                </tr>
                <?php
